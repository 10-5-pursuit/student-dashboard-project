        ...
        <div className="studentList">
            {students.map((student, index) => (
                <div className="studentList__students" key={index}>
                    <button onClick={() => setOpenComments(openComments === index ? null : index)}>
                {openComments === index ? 'Hide Comments' : 'Open Comments'}
            </button>
            {openComments === index && <CommentSection existingNotes={student.notes} />}
                    ...
                    <button onClick={() => setOpenExtraDetails(openExtraDetails === index ? null : index)}>
